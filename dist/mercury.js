...
var theWillComExtractor = {
  ...
  content: {
    selectors: [// Some figures will be inside div.article-text, but some header figures/images
    // will not.
    'div.field-item', 'div.field-items'],
    // Is there anything in the content you selected that needs transformed
    // before it's consumable content? E.g., unusual lazy loaded images
    transforms: {},
    // Is there anything that is in the result that shouldn't be?
...
var WwwTechnologyReviewComExtractor = {
...
var WwwWsjComExtractor = {
  ...
  content: {
    selectors: ['div.article-content' // enter content selectors
    ],
    // Is there anything in the content you selected that needs transformed
    // before it's consumable content? E.g., unusual lazy loaded images
    transforms: [],
...
var cleanStringNymag = function cleanStringNymag(text) {
